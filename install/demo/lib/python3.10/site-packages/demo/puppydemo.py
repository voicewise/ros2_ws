...
# Set yaw_rate to a positive value to ensure it turns left
PuppyMove = {'x': 0.0, 'y': 0.0, 'yaw_rate': 0.5}  
...
class PuppyDemoNode(Node):
    ...
    def timer_callback(self):
        # Publish updated velocity command to keep the robot turning left
        self.PuppyVelocityPub.publish(Velocity(x=PuppyMove['x'], y=PuppyMove['y'], yaw_rate=PuppyMove['yaw_rate']))
