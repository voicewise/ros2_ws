...
#ifndef PUPPY_CONTROL_MSGS__MSG__DETAIL__VELOCITY__FUNCTIONS_H_
#define PUPPY_CONTROL_MSGS__MSG__DETAIL__VELOCITY__FUNCTIONS_H_
 ...
 * calls
 * puppy_control_msgs__msg__Velocity__init().
...
/**
 * It calls
 * puppy_control_msgs__msg__Velocity__fini()
 ...
 * puppy_control_msgs__msg__Velocity__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * puppy_control_msgs__msg__Velocity__Sequence__fini()
 * on the array,
...
#endif  // PUPPY_CONTROL_MSGS__MSG__DETAIL__VELOCITY__FUNCTIONS_H_
