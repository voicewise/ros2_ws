...
class Pose(metaclass=Metaclass_Pose):
    ...
    def __init__(self, **kwargs):
        ...
        self.x_shift = kwargs.get('x_shift', float())
        self.stance_x = kwargs.get('stance_x', float())
        self.stance_y = kwargs.get('stance_y', float())
    ...
    def __eq__(self, other):
        ...
        if self.height != other.height:
            return False
        if self.x_shift != other.x_shift:
            return False
        if self.stance_x != other.stance_x:
            return False
        if self.stance_y != other.stance_y:
            return False
    ...
    def x_shift(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'x_shift' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'x_shift' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._x_shift = value

    @builtins.property
    def stance_x(self):
        """Message field 'stance_x'."""
        return self._stance_x

    @stance_x.setter
    def stance_x(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'stance_x' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'stance_x' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._stance_x = value

    @builtins.property
    def stance_y(self):
        """Message field 'stance_y'."""
        return self._stance_y

    @stance_y.setter
    def stance_y(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'stance_y' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'stance_y' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._stance_y = value
