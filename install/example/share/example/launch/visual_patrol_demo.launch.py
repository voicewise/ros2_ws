...
def generate_launch_description():
    return LaunchDescription([
        Node(
            package='example', 
            executable='visual_patrol_demo', 
            name='visual_patrol_node', 
            output='screen',
        ),
        ...
        #Node(
            ...
            #name='visual_patrol_demo_python_node',
            #output='screen',
            #arguments=['/home/ubuntu/ros2_ws/src/example/example/advanced_functions/include/visual_patrol_demo.py']
        #),
