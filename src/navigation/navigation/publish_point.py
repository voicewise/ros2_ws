...
class NavToPoseActionClient(Node):
    ...
    def __init__(self):
        ...
        # Iscriviti all'argomento posa target
    ...
    def goal_pose_callback(self, msg):
        ...
        self.get_logger().info('Position: X={0} Y={1}'.format(goal_position.x, goal_position.y))
    ...
    def send_goal(self, x, y, theta):
        ...
        goal_pose.pose.pose.position.z = 0.0        # La coordinata Z è solitamente 0
        goal_pose.pose.pose.orientation.w = 1.0     # Impostato su quaternione unitario senza rotazione
