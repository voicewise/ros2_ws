...
bool ros_robot_controller_msgs__msg__rgb_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_robot_controller_msgs.msg._rgb_state.RGBState", full_classname_dest, 49) == 0);
  }
  ros_robot_controller_msgs__msg__RGBState * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of RGBState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_robot_controller_msgs.msg._rgb_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RGBState");
