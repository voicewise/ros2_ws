...
static const _SetFloat64List_Request_type_support_symbol_names_t _SetFloat64List_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puppy_control_msgs, srv, SetFloat64List_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puppy_control_msgs, srv, SetFloat64List_Request)),
  }
};
...
{
  return &::puppy_control_msgs::srv::rosidl_typesupport_cpp::SetFloat64List_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, puppy_control_msgs, srv, SetFloat64List_Request)() {
  return get_message_type_support_handle<puppy_control_msgs::srv::SetFloat64List_Request>();
}
...
static const _SetFloat64List_Response_type_support_symbol_names_t _SetFloat64List_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puppy_control_msgs, srv, SetFloat64List_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puppy_control_msgs, srv, SetFloat64List_Response)),
  }
};
...
{
  return &::puppy_control_msgs::srv::rosidl_typesupport_cpp::SetFloat64List_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, puppy_control_msgs, srv, SetFloat64List_Response)() {
  return get_message_type_support_handle<puppy_control_msgs::srv::SetFloat64List_Response>();
}
...
static const _SetFloat64List_type_support_symbol_names_t _SetFloat64List_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puppy_control_msgs, srv, SetFloat64List)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puppy_control_msgs, srv, SetFloat64List)),
  }
};
...
{
  return &::puppy_control_msgs::srv::rosidl_typesupport_cpp::SetFloat64List_service_type_support_handle;
}
