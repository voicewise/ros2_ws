...
static const _Velocity_type_support_symbol_names_t _Velocity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, puppy_control_msgs, msg, Velocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, puppy_control_msgs, msg, Velocity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, puppy_control_msgs, msg, Velocity)() {
  return &::puppy_control_msgs::msg::rosidl_typesupport_c::Velocity_message_type_support_handle;
}
