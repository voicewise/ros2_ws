...
static const _SetFloat64List_Request_type_support_symbol_names_t _SetFloat64List_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, puppy_control_msgs, srv, SetFloat64List_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, puppy_control_msgs, srv, SetFloat64List_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, puppy_control_msgs, srv, SetFloat64List_Request)() {
  return &::puppy_control_msgs::srv::rosidl_typesupport_c::SetFloat64List_Request_message_type_support_handle;
}
...
static const _SetFloat64List_Response_type_support_symbol_names_t _SetFloat64List_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, puppy_control_msgs, srv, SetFloat64List_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, puppy_control_msgs, srv, SetFloat64List_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, puppy_control_msgs, srv, SetFloat64List_Response)() {
  return &::puppy_control_msgs::srv::rosidl_typesupport_c::SetFloat64List_Response_message_type_support_handle;
}
...
static const _SetFloat64List_type_support_symbol_names_t _SetFloat64List_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, puppy_control_msgs, srv, SetFloat64List)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, puppy_control_msgs, srv, SetFloat64List)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, puppy_control_msgs, srv, SetFloat64List)() {
  return &::puppy_control_msgs::srv::rosidl_typesupport_c::SetFloat64List_service_type_support_handle;
}
