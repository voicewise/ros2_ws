...
{
  new (message_memory) puppy_control_msgs::msg::Velocity(_init);
}

void Velocity_fini_function(void * message_memory)
{
  auto typed_message = static_cast<puppy_control_msgs::msg::Velocity *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Velocity_message_member_array[3] = {
  {
    ...
    offsetof(puppy_control_msgs::msg::Velocity, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(puppy_control_msgs::msg::Velocity, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(puppy_control_msgs::msg::Velocity, yaw_rate),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Velocity_message_members = {
  ...
  3,  // number of fields
  sizeof(puppy_control_msgs::msg::Velocity),
...
get_message_type_support_handle<puppy_control_msgs::msg::Velocity>()
{
  return &::puppy_control_msgs::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puppy_control_msgs, msg, Velocity)() {
  return &::puppy_control_msgs::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
