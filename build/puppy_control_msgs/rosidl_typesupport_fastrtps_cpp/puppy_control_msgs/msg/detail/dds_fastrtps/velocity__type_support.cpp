...
#include "puppy_control_msgs/msg/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const puppy_control_msgs::msg::Velocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  puppy_control_msgs::msg::Velocity & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = puppy_control_msgs::msg::Velocity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const puppy_control_msgs::msg::Velocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<puppy_control_msgs::msg::Velocity *>(
    untyped_ros_message);
...
{
  return &puppy_control_msgs::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puppy_control_msgs, msg, Velocity)() {
  return &puppy_control_msgs::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
