...
#include "puppy_control_msgs/msg/detail/velocity__rosidl_typesupport_fastrtps_c.h"
...
using _Velocity__ros_msg_type = puppy_control_msgs__msg__Velocity;
...
size_t get_serialized_size_puppy_control_msgs__msg__Velocity(
  const void * untyped_ros_message,
...
static uint32_t _Velocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_puppy_control_msgs__msg__Velocity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_puppy_control_msgs
size_t max_serialized_size_puppy_control_msgs__msg__Velocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = puppy_control_msgs__msg__Velocity;
    is_plain =
      (
...
static size_t _Velocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_puppy_control_msgs__msg__Velocity(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, puppy_control_msgs, msg, Velocity)() {
